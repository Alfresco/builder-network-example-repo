This document is buried inside a directory that is not specified in the file
...
- [Relative link to other file fragment](../README.md#test)
...
<div id="test"><p>This is some linked content</p></div>
